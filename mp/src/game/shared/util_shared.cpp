...
char* ReadAndAllocStringValue( KeyValues *pSub, const char *pName, const char *pFilename, const char *defaultValue )
{
	const char *pValue = pSub->GetString( pName, defaultValue );
	if ( !pValue )
	{
		if ( pFilename )
		{
